# code taken from https://github.com/clovaai/deep-text-recognition-benchmark with one small change adding opt NameSpace on line 15-55
import numpy as np
import torch
...
class Model(nn.Module):
    def __init__(self,num_class,input_channel,output_channel,hidden_size):
        ...
        # I added this opt code myself
        opt = Namespace()
        opt.batch_size = 2
        opt.batch_max_length = 80
        opt.imgH = 32
        opt.imgW = 100
        opt.character = '0123456789abcdefghijklmnopqrstuvwxyz'
        opt.num_class = len(opt.character)+2 #TODO change this
        opt.PAD = False
